...
class LMClass(BaseLM):
    def __init__(self, args):
        ...
        #print(self._device)#cuda

        self.model_name = args.model
        #print(self.model_name)#/home/kris/workspace/sunkaiwei/Quant/LLMQuant_HW/checkpoints/Qwen/Qwen3.5-4B

        self.batch_size_per_gpu = args.batch_size
        #print(self.batch_size_per_gpu)#1

        self.model_config = args.model
        #print(self.model_config)#/home/kris/workspace/sunkaiwei/Quant/LLMQuant_HW/checkpoints/Qwen/Qwen3.5-4B
